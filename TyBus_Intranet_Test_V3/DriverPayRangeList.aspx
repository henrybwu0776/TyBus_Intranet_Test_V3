<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="DriverPayRangeList.aspx.cs" Inherits="TyBus_Intranet_Test_V3.DriverPayRangeList" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<asp:Content ID="DriverPayRangeListForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <a class="titleText-Red">各單位駕駛員薪資發放級距統計表</a>
    </div>
    <br />
    ...
    <asp:Panel ID="plShowData" runat="server" CssClass="ShowPanel">
        <asp:GridView ID="gridDriverPayRangeList" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="sdsDriverPayRangeList" GridLines="Horizontal" Width="100%">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DepCount" HeaderText="配置人數" ReadOnly="True" SortExpression="DepCount" />
    ...
    <asp:Panel ID="plReport" runat="server" CssClass="PrintPanel">
        ...
        <rsweb:ReportViewer ID="rvPrint" runat="server" BackColor="" ClientIDMode="AutoID" HighlightBackgroundColor=""
            ...
            <LocalReport ReportPath="Report\DriverPayRangeListP.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </asp:Panel>
    <asp:SqlDataSource ID="sdsDriverPayRangeList" runat="server" ConnectionString="<%$ ConnectionStrings:connERPSQL %>" ProviderName="<%$ ConnectionStrings:connERPSQL.ProviderName %>" SelectCommand="SELECT depno, CAST('' AS varchar) AS DepName, CAST(0 AS int) AS DepCount, CAST(0 AS int) AS RCount_1, CAST(0 AS int) AS RCount_2, CAST(0 AS int) AS RCount_3, CAST(0 AS int) AS RCount_4, CAST(0 AS int) AS RCount_5, CAST(0 AS int) AS RCount_6, CAST(0 AS int) AS RCount_7, CAST(0 AS int) AS RCount_8, CAST(0 AS int) AS RCount_9 FROM PAYREC AS p WHERE (1 &lt;&gt; 1)"></asp:SqlDataSource>
</asp:Content>
