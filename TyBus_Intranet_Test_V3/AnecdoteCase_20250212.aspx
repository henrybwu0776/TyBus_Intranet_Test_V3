...
<asp:Content ID="AnecdoteCaseForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <ContentTemplate>
                        <table class="TableSetting">
                            <tr>
                                ...
                                <td class="ColHeight ColBorder ColWidth-8Col">
                                    <asp:Label ID="lbBuildDate_Edit" runat="server" CssClass="text-Right-Blue" Text="出險日期：" Width="90%" />
                                </td>
                                <td class="ColHeight ColBorder ColWidth-8Col">
                    ...
                    <ContentTemplate>
                        <table class="TableSetting">
                            <tr>
                                ...
                                <td class="ColHeight ColBorder ColWidth-8Col">
                                    <asp:Label ID="lbBuildDate_INS" runat="server" CssClass="text-Right-Blue" Text="出險日期：" Width="90%" />
                                </td>
                                <td class="ColHeight ColBorder ColWidth-8Col">
            ...
            <ItemTemplate>
                ...
                <table class="TableSetting">
                    <tr>
                        ...
                        <td class="ColHeight ColBorder ColWidth-8Col">
                            <asp:Label ID="lbBuildDate_List" runat="server" CssClass="text-Right-Blue" Text="出險日期：" Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-8Col">
  ...
  FROM AnecdoteCase AS a left join Employee b on b.EmpNo = a.BuildMan WHERE (1 &lt;&gt; 1)"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsAnecdoteCaseA_Data" runat="server" ConnectionString="<%$ ConnectionStrings:connERPSQL %>" 
        ...
        SelectCommand="SELECT a. CaseNo, a.HasInsurance, a.DepNo, a.DepName, a.BuildDate, a.BuildMan, b.[NAME] as BuildManName, a.Car_ID, a.Driver, a.DriverName, a.InsuMan, a.AnecdotalResRatio, 
       a.IsNoDeduction, a.DeductionDate, a.Remark, a.CaseOccurrence, a.ERPCouseNo, a.CaseClose, a.InsuAmount, a.PenaltyRatio, a.Penalty, a.PaidAmount, a.IsExemption, 
	   a.IDCardNo, a.Birthday, a.Assumeday, a.TelephoneNo, a.[Address], a.PersonDamage, a.CarDamage, a.ReportDate, a.CaseDate, a.CaseTime, a.OutReportNo, a.CasePosition, 
	   a.PoliceUnit, a.PoliceName, a.HasVideo, a.NoVideoReason, a.HasCaseData
  FROM AnecdoteCase AS a left join Employee b on b.EmpNo = a.BuildMan WHERE (CaseNo = @CaseNo)" 
