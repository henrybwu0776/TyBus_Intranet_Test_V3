<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="DriverWorkHoursStatistics.aspx.cs" Inherits="TyBus_Intranet_Test_V3.DriverWorkHoursStatistics" %>
<asp:Content ID="DriverWorkHoursStatisticsForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <a class="titleText-Red">駕駛員時數統計月結查詢</a>
    </div>
    <br />
        ...
        <asp:FormView ID="fvDriverWorkHoursData" runat="server" DataSourceID="sdsDriverWorkHoursData" Width="100%">
            ...
            <ItemTemplate>
                <table class="TableSetting">
                    ...
                    <tr>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="lbOver133" runat="server" CssClass="text-Right-Blue" Text="1.33加班" Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="eOver133" runat="server" CssClass="text-Left-Black" Text='<%# Eval("CALHOURS_02") %>' Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="lbOver166" runat="server" CssClass="text-Right-Blue" Text="1.66加班" Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="eOver166" runat="server" CssClass="text-Left-Black" Text='<%# Eval("CALHOURS_03") %>' Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="lbOver266" runat="server" CssClass="text-Right-Blue" Text="2.66加班" Width="90%" />
                        </td>
                        <td class="ColHeight ColBorder ColWidth-7Col">
                            <asp:Label ID="eOver266" runat="server" CssClass="text-Left-Black" Text='<%# Eval("CALHOURS_04") %>' Width="90%" />
                        </td>
                    </tr>
                    <tr>
                        <td class="Title1 ColBorder ColWidth-7Col" colspan="7">
