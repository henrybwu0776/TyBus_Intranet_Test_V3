<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="DriverWorkHourLevelByMan.aspx.cs" Inherits="TyBus_Intranet_Test_V3.DriverWorkHourLevelByMan" %>

<%@ Register Assembly="Microsoft.ReportViewer.WebForms" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<asp:Content ID="DriverWorkHourLevelByManForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <a class="titleText-Red">駕駛員工時級數分析表(人)</a>
    </div>
    ...
    <asp:Panel ID="plPrint" runat="server" CssClass="PrintPanel">
        ...
        <rsweb:ReportViewer ID="rvPrint" runat="server" BackColor="" ClientIDMode="AutoID" HighlightBackgroundColor=""
            ...
            <LocalReport ReportPath="Report\DriverWorkHourLevelByManP.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </asp:Panel>
