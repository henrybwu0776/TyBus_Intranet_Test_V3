...
<body>
    <form id="SearchSupForm" runat="server">
        <div>
            ...
            <asp:GridView ID="gridSupData_Search" runat="server" CssClass="text-Left-Black" Width="600px" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="code" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gridSupData_Search_PageIndexChanging">
